...
export async function populate() {
	...
	const generalCategoryId = await db.addCategory({});
	await db.addTranslation({
		language: "fr",
		objectType: "Category",
		objectId: generalCategoryId,
		value: "Général"
	});
	await db.addTranslation({
		language: "en",
	...
	const greetingsCategoryId = await db.addCategory({});
	await db.addTranslation({
		language: "fr",
		objectType: "Category",
		objectId: greetingsCategoryId,
		value: "Salutations"
	});
	await db.addTranslation({
		language: "en",
	...
	const politenessCategoryId = await db.addCategory({});
	await db.addTranslation({
		language: "fr",
		objectType: "Category",
		objectId: politenessCategoryId,
		value: "Politesse"
	});
	await db.addTranslation({
		language: "en",
	...
	const placesCategoryId = await db.addCategory({});
	await db.addTranslation({
		language: "fr",
		objectType: "Category",
		objectId: placesCategoryId,
		value: "Lieux"
	});
	await db.addTranslation({
		language: "en",
