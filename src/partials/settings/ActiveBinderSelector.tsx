	...
	return (
		<>
			...
			<Select.Root
				...
				<Select.Trigger id="active-binder-selector" className={cn("h-10 min-w-36 mt-auto mr-auto flex items-center justify-between px-2 gap-2 rounded-md border text-base select-none")}>
